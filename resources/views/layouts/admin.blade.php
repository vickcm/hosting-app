            ...
            <nav class="sidebar-menu">
                <ul class="list-unstyled">
                    <li class="nav-item mb-3">
                        <a class="nav-link" href="{{ route('dashboardPosts') }}">
                    ...
                    <li class="nav-item mb-3">
                        <a class="nav-link" href="{{ route('dashboardCategories') }}">
                    ...
                    <li class="nav-item">
                        <form action="{{ route('auth.processLogout') }}" method="post">
                            @csrf
                            <button type="submit" class="btn nav-link fs-6">
    ...
    <main>
        <header class="dashboard-header">
            <div class="d-flex">
                ...
                <label class="text-center fs-2 mt-1 mb-0 mt-md-0 mb-md-1">Panel de Administración || <span>NuveWeb</span></label>
            </div>
        </header>
