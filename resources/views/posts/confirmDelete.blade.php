...
@section('abm-post')
    <h1 class="text-center borrar-titulo">Entrada seleccionada para borrar  
    ...
    <div class="mt-3">
        <form action="{{ route('posts.processDelete', ['id' => $post->id] ) }}" method="post" class="d-flex flex-column justify-content-center align-items-center">
            @csrf
            <p class="fw-bold">
